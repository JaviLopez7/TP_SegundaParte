...
export class RegistrarUsuarioComponent {
  ...
  nombre: new FormControl('', [Validators.required, Validators.pattern(SOLO_LETRAS_PATTERN)]),
  apellido: new FormControl('', [Validators.required, Validators.pattern(SOLO_LETRAS_PATTERN)]),
  correo: new FormControl('', [Validators.required, Validators.email]),
  contrasenia: new FormControl('', [Validators.required, Validators.pattern(PASSWORD_PATTERN)]),
